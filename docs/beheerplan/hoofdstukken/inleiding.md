...
Het IMBOR beschrijft een uniforme naamgeving van objecttypen en hun onderlinge relaties die voorkomen in de openbare ruimte met de kenmerken en domeinwaarden die relevant zijn voor het beheer. Het IMBOR is een vastgesteld en actueel product dat wordt gebruikt in de markt. Het IMBOR wordt verder beproefd en verbeterd en wordt als standaard nog doorontwikkeld. Hoe deze doorontwikkeling gebeurt wordt in dit plan beschreven.
