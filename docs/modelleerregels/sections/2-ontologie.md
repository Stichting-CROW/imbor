...
| | |
| ----- | ---- | 
| *Regel* | Er worden alleen Typen toegevoegd aan de IMBOR-taxonomie als:
i.	Het Type niet uit te drukken valt m.b.v. een bestaand attribuut;
ii.	Het Type logischerwijs in meer dan één geval voorkomt in de werkelijkheid;
iii.	Het Type binnen de scope van IMBOR valt; en 
iv.	De toepassing van het Type niet te niche is binnen de scope van IMBOR. | 
