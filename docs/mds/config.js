var respecConfig = {
  ...
  specType: "documentatie", // vrije tekst
  specStatus: "LD", // kies uit https://github.com/Stichting-CROW/respec/wiki/specStatus
  ...
  editors: [
    {
      name: "Thijs | CROW", // verplicht, de rest is optioneel
    }
  ],
