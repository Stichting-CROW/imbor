...
insert {
    graph <https://data.crow.nl/imbor/addendum/referentiemodellen> {
        ?mapping imbor-refmodels:refAttribuutDomeinwaarde ( ?a1 ?a2 ) , ( ?b1 ?b2 ) , ( ?c1 ?c2 ) .
    }
} where {
    graph <https://data.crow.nl/imbor/addendum/referentiemodellen-temp> {
        ?mapping imbor-refmodels:refAttribuutDomeinwaarde ( ?aa ?bb ?cc ) .
...
insert {
    graph <https://data.crow.nl/imbor/addendum/referentiemodellen> {
        ?mapping imbor-refmodels:refAttribuutDomeinwaarde ( ?a1 ?a2 ) , ( ?b1 ?b2 ) .
    }
} where {
    graph <https://data.crow.nl/imbor/addendum/referentiemodellen-temp> {
        ?mapping imbor-refmodels:refAttribuutDomeinwaarde ( ?aa ?bb ?cc ) .
...
insert {
    graph <https://data.crow.nl/imbor/addendum/referentiemodellen> {
        ?mapping imbor-refmodels:refAttribuutDomeinwaarde ( ?a1 ?a2 ) .
    }
} where {
    graph <https://data.crow.nl/imbor/addendum/referentiemodellen-temp> {
        ?mapping imbor-refmodels:refAttribuutDomeinwaarde ( ?aa ?bb ?cc ) .
